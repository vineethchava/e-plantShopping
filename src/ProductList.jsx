...
function ProductList() {
  ...
  // Helper function to check if the item is already in the cart and get its quantity
                ...
                {category.plants.map((plant, plantIndex) => (
                  <div className="product-card" key={plantIndex}>
                    ...
                    <button
                      ...
                      disabled={getItemQuantity(plant.name) > 0} // Disable button if added to cart
                    >
                      {getItemQuantity(plant.name) > 0 ? 'Added' : 'Add to Cart'}
                    </button>
                  </div>
                ))}
              </div>
